...
export const Snippet = ({ className, ...props }: SnippetProps) => (
  <Tabs
    className={cn(
      'group w-full gap-0 overflow-hidden rounded-md border border-foreground/40 shadow-sm',
      className
    )}
    {...props}
  />
...
export const SnippetHeader = ({ className, ...props }: SnippetHeaderProps) => (
  <div
    className={cn(
      'flex flex-row items-center justify-between border-b border-foreground/40 bg-secondary p-1',
      className
    )}
    {...props}
  />
